...
\begin{ex}
 \emph{$ H_0 $: выборка из распределения Пуассона с параметром $
 \lambda = 2 $} ---
 простая параметрическая гипотеза.

 \emph{$ H_1 $: выборка из нормального распределения} --- сложная
 непараметрическая гипотеза.

 \emph{$ H_2 $: выборка из распределения с параметром $ \theta = \theta_0
$} --- простая параметрическая гипотеза, если $ \theta \in \mathbb R $.

 \emph{$ H_3 $: выборка из нормального распределения с параметром $ a = 0
 $} --- сложная параметрическая гипотеза.

 \emph{$ H_4 $: монета правильная} --- простая гипотеза.

 \emph{$ H_5 $: монета неправильная} --- сложная гипотеза.
\end{ex}
...
\begin{solution}
  ...
  % \begin{figure}[h!]
		...
		% \caption{Функция мощности критерия S от $\alpha$}
		% \label{fig:9-plot2}
	% \end{figure}
\end{solution}
\end{ex}
